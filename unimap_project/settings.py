"""
Django settings for unimap_project project.
...
SECRET_KEY = 'django-insecure-1!h^&z*5@edx40&4-tp0=9dg0v@$yhl!5!l60y#+*6)mxkw7hd'

#Open route sevice api 
...
MIDDLEWARE = [
    ...
    'django.contrib.sessions.middleware.SessionMiddleware',  #required sessions must run befor tracking middleware
